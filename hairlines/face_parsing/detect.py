...
import numpy as np
import cv2
from hairlines.face_parsing.model import BiSeNet
import matplotlib.pyplot as plt


def load_model(model_path="hairlines/face_parsing/79999_iter.pth"):
...
def load_bisenet():
    model = load_model("hairlines/face_parsing/79999_iter.pth")
    return model
