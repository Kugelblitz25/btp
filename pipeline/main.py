...
from hairline.face_parsing.detect import Hairline, load_bisenet
import json
import cv2
...
with Camera(vid_loc) as camera:
    ...
    for frame in camera.frames():
        ...
        for id in results:
            ...
            race_pred,age_pred, gender_pred, race_score, age_score, gender_score = predict_age_gender_race(face_crop,fair_face)
